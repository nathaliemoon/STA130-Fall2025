...
-   What is the name of the fifth variable in the `avatar` tibble? Save your answer in the R object below called `Q3_fifth_variable_name` (replace NULL with your answer). Hint: when your answer is a word, make sure to put it in quotation marks.
